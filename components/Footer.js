    ...
    <footer className="page-footer z-depth-5">
        ...
        <div className="footer-copyright">
            <div className="container black-text">
                &copy; <span id="footerYear">2020</span> <Link href="//msg-st.wildscript.tech/images/blank_render_logo.webp"><a className="styled-link" target="_blank" rel="noreferrer" title="Blank Render, Inc." aria-label="Blank Render, Inc."><b>lank Render, Inc.</b></a></Link> All rights reserved. | <Link href="//docs.msg-st.wildscript.tech/"><a className="styled-link" target="_blank" rel="noreferrer" title="API Documentation" aria-label="API Documentation"><b>API Documentation</b></a></Link>
